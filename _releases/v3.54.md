...
## Flutter: Create New Project Platform Defaults

[#4284](https://github.com/Dart-Code/Dart-Code/issues/4284): When creating a new Flutter project using the **Flutter: Create New Project** command it's now possible to set the default platforms that should be enabled for new projects. This can be accessed from the "cog" icon when entering the project name.
...
- [#4283](https://github.com/Dart-Code/Dart-Code/issues/4283): The **Flutter: Create New Project** settings editor now pre-selects the existing selected values in single-selection lists.
