...
- [#4527](https://github.com/Dart-Code/Dart-Code/issues/4527): The default project names when using the **Dart: Create New Project** and **Flutter: Create New Project** commands have been updated to better reflect the kind of project. For example selecting the "package" template will provide a default name of `dart_package_1` instead of `dart_application_1`.
