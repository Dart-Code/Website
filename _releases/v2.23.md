...
A new command **Dart: Create New Project** has been added that works similar to the existing **Flutter: Create New Project** and **Flutter: Create New Project From Docs** commands:
