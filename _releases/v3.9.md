...
excerpt: Create New Project offline mode, Terminal improvements...
---
...
## Flutter: Create New Project Offline Mode

[#1957](https://github.com/Dart-Code/Dart-Code/issues/1957)/[#2311](https://github.com/Dart-Code/Dart-Code/issues/2311): [@ejabu](https://github.com/ejabu) Contributed a new setting `dart.flutterCreateOffline` that will cause **Flutter: Create New Project** to run in offline-mode.
