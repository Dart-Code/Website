...
## Flutter: Create New Project From Docs

It's now possible to create sample projects from the Flutter docs directly in VS Code with a new command **Flutter: Create New Project From Docs**.
