...
- [#3179](https://github.com/Dart-Code/Dart-Code/issues/3179)/[#3238](https://github.com/Dart-Code/Dart-Code/issues/3238): The **Dart: Create New Project** command now uses `dart create` instead of Stagehand for Dart SDK versions >= v2.10.0.
