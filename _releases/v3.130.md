...
# v3.130.1 _2026-03-04_

- [#5954](https://github.com/Dart-Code/Dart-Code/issues/5954)/[#5957](https://github.com/Dart-Code/Dart-Code/issues/5957): Fixed an issue where some users see an ENOTDIR error when trying to launch a debug session.
...
- [#5135](https://github.com/Dart-Code/Dart-Code/issues/5135): Various changes have been made to make the display of getters and field more accurate. Many places that would previously show fields will now correctly show the implicit getters they produce.
