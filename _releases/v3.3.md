...
- The **Flutter: Create New Project From Docs** command has been renamed to **Flutter: Open Widget Sample** to better reflect its intent to provide working code sample code and not a template for new projects.
