...
- [#1659](https://github.com/Dart-Code/Dart-Code/issues/1659): `pub get` will no longer fire multiple times concurrently during creation of projects with `Dart: Create New Project` and `Flutter: Create New Project`.
- [#1666](https://github.com/Dart-Code/Dart-Code/issues/1666): Projects created with `Flutter: Create New Project` will once again show the device selector in the status bar without having to reload the folder after initial creation.
