...
- [#3050](https://github.com/Dart-Code/Dart-Code/issues/3050)/[#3084](https://github.com/Dart-Code/Dart-Code/issues/3084): New toolbar buttons have been added to the top of the test tree for easy running of all, failed, skipped tests, clearing test results and menu entry for toggling hidden tests.
...
- [#1900](https://github.com/Dart-Code/Dart-Code/issues/1900): Allow changing the color of named paramter labels in themes.
...
- [#2800](https://github.com/Dart-Code/Dart-Code/issues/2800): Comments thatn span multiple lines can now be collapsed using code folding (requires SDK update).
...
- [#3033](https://github.com/Dart-Code/Dart-Code/issues/3033): Hot-reload-on-save no longer fires for Save events triggered by VS Code's auto-save feature. Pressing Save manually (even if there are no unsaved changes) will still trigger a reload.
