...
- [#2592](https://github.com/Dart-Code/Dart-Code/issues/2592)/[#2597](https://github.com/Dart-Code/Dart-Code/issues/2597): The change to use standard DAP messages for debugger progress events caused events taking less than 500ms to now show (for example Hot Reload/Restart requests). This change has been partially-reverted (pending [a change in VS Code](https://github.com/microsoft/vscode/issues/101405)), though notifications will still only show in the status bar by default.
