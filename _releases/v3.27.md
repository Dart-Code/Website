...
- [#3580](https://github.com/Dart-Code/Dart-Code/issues/3580): Running commands like **Flutter: Create New Project** in an empty workspace will now correctly initialize the Flutter SDK automatically.
...
- [#3554](https://github.com/Dart-Code/Dart-Code/issues/3554): The various **Flutter: New XYZ Project** commands have been folded together into a single **Flutter: Create New Project** command that lists the available templates. Included in this list is the new "skeleton" project template added in Flutter 2.5.0.
...
- [#3561](https://github.com/Dart-Code/Dart-Code/issues/3561): The **Dart/Flutter: Create New Project** commands now default to the folders last used when invoking these commands.
