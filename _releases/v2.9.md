...
excerpt: "'Flutter: Create New Project' command, improved SDK detection, missing package detection..."
---

# v2.9.2

- Running `Flutter: Create New Project` will no longer complain about missing SDKs if `dart` is not in your `PATH`

---

# v2.9.1

- A more appropriate error message is now shown when running `Flutter: Create New Project` when Flutter cannot be found

---

# v2.9.0

- A new command (`Flutter: Create New Project`) has been created to simplify the process of creating and opening a new Flutter project (unlike others, this command is in the palette even without a project open)
