...
- `Flutter: Create New Project` will now validate that you do not call your project `flutter` or `flutter_test` which would lead to confusing errors about depending on itself
...
- The SDK quick-picker will no longer show an error if configured folders contain symlinks to Dart binaries
