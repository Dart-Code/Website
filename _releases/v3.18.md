...
- [#2963](https://github.com/Dart-Code/Dart-Code/issues/2963)/[#3004](https://github.com/Dart-Code/Dart-Code/issues/3004): New commands have been added to create module, plugin and package Flutter projects. The original **Flutter: Create New Project** command is now named **Flutter: New Application Project** to avoid ambiguity.
