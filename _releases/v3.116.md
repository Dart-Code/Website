...
- [#5591](https://github.com/Dart-Code/Dart-Code/issues/5591): The **Flutter: Create New Project** command no longer shows the "Skeleton" option that was removed in Flutter 3.29.
