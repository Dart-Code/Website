...
- [#2024](https://github.com/Dart-Code/Dart-Code/issues/2024)/[#2037](https://github.com/Dart-Code/Dart-Code/issues/2037): Creating new projects with `Flutter: Create New Project` and `Dart: Create New Project` will now use the current-workspace SDK path (as selected with the **Change SDK** commands) for project creation, by writing the setting into the newly-created project's VS Code workspace settings file.
