...
- [#4606](https://github.com/Dart-Code/Dart-Code/issues/4606): The **Dart: Create New Project** and **Flutter: Create New Project** input boxes no longer close automatically if focus is lost. This allows you to tab away (for example to copy/paste values) without having to start over. Pressing `<escape>` will still cancel project creation.
